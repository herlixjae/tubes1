...
if(isset($_POST["button"]))
{
	...
	$rs=mysql_query("INSERT INTO post_article (`title`, `featurephoto`, `post_entry`, `create_date`,`create_by`,`hit`,`id_cat`,`status`) VALUES ('".$_POST['judul']."','".$_POST['photo']."', '".$_POST['editor1']."','".$skrg."','admin','0','".$_POST['kategori']."','1')") or die(mysql_error());
