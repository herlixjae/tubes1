...
<?php
	...
	$count_query   = mysql_query("SELECT COUNT(post_id) AS numrows FROM post_article Where status='0'",$con);
...
FROM post_article LEFT JOIN post_category ON post_article.id_cat = post_category.id_cat Where  status='0' GROUP BY post_id LIMIT $offset,$per_page");
?>
<span class="span4">
