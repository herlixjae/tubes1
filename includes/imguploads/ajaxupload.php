...
require("../../config.php");
?>
<link rel="stylesheet" href="<?php echo $base_url."css/css/style.default.css"; ?>" type="text/css" />
...
$path = "../../uploads/images/"; //set your folder path
			...
			if(move_uploaded_file($tmp, $path.$actual_image_name)) //check the path if it is fine
				{
					...
					echo "<img src='../../uploads/images/".$actual_image_name."'  class='preview' width='200px' height='200px'> <br><input type='hidden' name='actual_image_name' id='actual_image_name' value='$actual_image_name' />";
					?><br />
                    <a href="#" onClick="sendValue('<?php echo $actual_image_name; ?>','photo','<?php echo $ext; ?>','ext','<?php echo $actual_image_name; ?>','nfile');"><span class="btn btn-success"><i class="icon-edit"></i>Pilih</span></a></td>   
                    <?php
				}
			else
				{
