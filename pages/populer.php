...
$q=mysql_query("Select * from post_article Where post_article.status='1' order by hit desc");
...
?>
 <div class="featured_post">
                        ...
                        <div class="featured_list">
                        	...
                        	<ul>
                            <?php
$r=mysql_query("Select * from post_article where post_id!='".$qr['post_id']."' and status='1' order by hit desc LIMIT 0,".$limit_post_home."");
